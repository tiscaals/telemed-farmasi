...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="/auth/assets/img/logo/RSUD2.png">

    <!-- page css -->

    <!-- Core css -->
    <link href="/auth/assets/css/app.min.css" rel="stylesheet">
...
<body>
        ...
        <div class="layout">
            ...
            <div class="header">
                <div class="logo logo-dark">
                    <a href="index.html">
                        <img src="/auth/assets/img/logo/logo-rs.png" alt="Logo">
                        <img class="logo-fold" src="/auth/assets/img/logo/logo-rs.png" alt="Logo">
                    </a>
                </div>
                        ...
                        <li class="dropdown dropdown-animated scale-left">
                            <div class="pointer" data-toggle="dropdown">
                                <div class="avatar avatar-image  m-h-10 m-r-15">
                                    <img src="/auth/assets/images/avatars/thumb-3.jpg"  alt="">
                                </div>
                            </div>
                            <div class="p-b-15 p-t-20 dropdown-menu pop-profile">
                                ...
                                <a href="/auth/user/profile.php" class="dropdown-item d-block p-h-15 p-v-10">
                                                ...
                                                <tbody>
                                                        ...
                                                        <td>
                                                            <div class="media align-items-center">
                                                                <div class="avatar avatar-image rounded">
                                                                    <img src="/auth/assets/images/others/thumb-9.jpg" alt="">
                                                                </div>
                                                                <div class="m-l-10">
                                                                    <span>Gray Sofa</span>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="media align-items-center">
                                                                <div class="avatar avatar-image rounded">
                                                                    <img src="/auth/assets/images/others/thumb-10.jpg" alt="">
                                                                </div>
                                                                <div class="m-l-10">
                                                                    <span>Gray Sofa</span>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="media align-items-center">
                                                                <div class="avatar avatar-image rounded">
                                                                    <img src="/auth/assets/images/others/thumb-11.jpg" alt="">
                                                                </div>
                                                                <div class="m-l-10">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="media align-items-center">
                                                                <div class="avatar avatar-image rounded">
                                                                    <img src="/auth/assets/images/others/thumb-12.jpg" alt="">
                                                                </div>
                                                                <div class="m-l-10">
                                                                    <span>Red Chair</span>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="media align-items-center">
                                                                <div class="avatar avatar-image rounded">
                                                                    <img src="/auth/assets/images/others/thumb-13.jpg" alt="">
                                                                </div>
                                                                <div class="m-l-10">
                                                                    <span>Wristband</span>
                                                                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body scrollable">
                            ...
                            <div class="m-t-30">
                                ...
                                <div class="d-flex m-b-30">
                                    <div class="avatar avatar-image">
                                        <img src="/auth/assets/images/avatars/thumb-1.jpg" alt="">
                                    </div>
                                    <div class="m-l-15">
                                ...
                                <div class="d-flex m-b-30">
                                    <div class="avatar avatar-image">
                                        <img src="/auth/assets/images/avatars/thumb-2.jpg" alt="">
                                    </div>
                                    <div class="m-l-15">
                            ...
                            <div class="m-t-30">
                                ...
                                <div class="d-flex m-b-30">
                                    <div class="avatar avatar-image">
                                        <img src="/auth/assets/images/others/img-1.jpg" alt="">
                                    </div>
                                    <div class="m-l-15">
    ...
    <!-- Core Vendors JS -->
    <script src="/auth/assets/js/vendors.min.js"></script>

    <!-- page js -->
    <script src="/auth/assets/vendors/chartjs/Chart.min.js"></script>
    <script src="/auth/assets/js/pages/dashboard-default.js"></script>

    <!-- Core JS -->
    <script src="/auth/assets/js/app.min.js"></script>
