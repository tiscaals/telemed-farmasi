        ...
        <div class="layout">
            ...
            <div class="page-container">
                ...
                <div class="main-content">
                    <!-- Banner START -->
                    <div class="card img-fluid center text-white">
                        <div class="card" style="padding:60px 0; text-align: center; background-image: linear-gradient(to bottom right, #31476E, #64B8FF);">
                            <div class="inner-title">
                                <h3 style="font-size: 2.8em;font-weight: 800;color: white;">Selamat Datang di Layanan Telemedicine </h3>
                                <h5 style="font-size: 1.1em;padding: 10px 20px;font-weight: 100;letter-spacing: 5px; color: white;">dr. <?php echo $nama ?></h5>
                                <a href="konsultasi.php" class="btn-lg btn-light" style="display: inline-block;">Cek Konsultasi Baru</a>
                            </div>
                        </div>
                    </div>
                    <!-- Banner START -->
                    ...
                    <div class="card-body text-center">
                        <h3 style="padding: 10px 0;">Alur Konsultasi Dokter</h3>
                        <img class="img-fluid" src="../assets/img/alur_dokter.png" alt="Alur Konsultasi">
                    </div>
                    </div>
                </div>
                <!-- Content Wrapper END -->
