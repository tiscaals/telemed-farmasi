            ...
            <div class="header">
                <div class="logo logo-dark">
                    <a href="">
                        ...
                        <img class="logo-fold" src="../assets/img/logo-rs.png" alt="Logo" style="max-width: 60px; margin: auto;">
                    </a>
                </div>
                <div class="logo logo-white">
                    <a href="">
                        <img src="../assets/img/logo-rs.png" alt="Logo" style="max-height: 65px;">
                        <img class="logo-fold" src="../assets/img/logo-rs.png" alt="Logo" style="max-width: 60px;">
                    </a>
                </div>
                <div class="nav-wrap">
                    <ul class="nav-left">
                ...
                <div class="main-content">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="m-t-25">
                                <?php
                                $result = $conn->query("SELECT * FROM reservasi JOIN user ON reservasi.user_id = user.user_id WHERE reservasi.status_reservasi != 'Selesai Konsultasi' AND nip_dokter = (SELECT nip FROM user_dokter WHERE user_id='$user_id');");
                                ...
                                ?>
                                    <table id="data-table" class="table">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr id="<?php echo $row['reservasi_id']; ?>">
                                                    <td><?php echo $row["tgl_reservasi"]; ?></td>
                                                    <td><?php echo $row["user_id"]; ?></td>
                                                    <td><?php echo $row["reservasi_id"]; ?></td>
                                                    <td><?php echo $row["nama_lengkap"]; ?></td>
                                                    <td><a href=<?php echo $row["url_link"]; ?>><?php echo $row["url_link"]; ?></a>
                                                    <td>
                                                        <a href="hasil-konsultasi.php?reservasi_id=<?php echo $row['reservasi_id']; ?>" class="btn btn-link">
                                                            Tulis diagnosa & resep
                                                        </a>
                                                    </td>
                                                </tr>
                                            <?php
