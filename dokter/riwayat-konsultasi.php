            ...
            <div class="page-container">
                ...
                <div class="main-content">
                    <div class="page-header">
                        <h2 class="header-title">Riwayat Konsultasi</h2>
                                            ...
                                            ?>
                                                <tr id="<?php echo $row['reservasi_id']; ?>">
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="modal fade" id="hasilkonsul<?php echo $row['reservasi_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="hasilkonsulLabel" aria-hidden="true">
