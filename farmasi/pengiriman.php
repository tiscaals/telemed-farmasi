<?php
    ...
    if(isset($_POST["resi"])){
        ...
        if(empty($resi)){
            $error_log = '*Masukkan Nomor Resi!';
        } else {
            $add_resi = mysqli_query($conn, "UPDATE pengiriman SET url_resi='$resi' WHERE transaksi_id='$transaksi_id'");
            if($add_resi === true)
            {
                $update_status = mysqli_query($conn, "UPDATE pengiriman SET status_pengiriman='Sudah Dikirim' WHERE transaksi_id='$transaksi_id'");
                $listobat = $conn -> query("SELECT * FROM resep_obat JOIN obat ON resep_obat.obat_id = obat.obat_id WHERE transaksi_id = '$transaksi_id';");
                    while($rowobat = mysqli_fetch_assoc($listobat)) {
                        ...
                        $stocknow = $rowobat["qty"]-$rowobat["qty_beli"];
                        $update_stock = mysqli_query($conn, "UPDATE obat SET qty='$stocknow' WHERE obat_id='$obat_id'");
                    }
                    header("location:tabel_pengiriman.php?pesan=success");
            }
            else
            {
                $error_log = 'Ups, pengiriman tidak tersimpan!';
            } 
        }
    }
?>
            ...
            <div class="page-container">
                ...
                <div class="main-content">
                    ...
                    <div class="page-header">
                        <h2 class="header-title">Atur Pengiriman</h2>
                        <div class="header-sub-title">
                            <nav class="breadcrumb breadcrumb-dash">
                                ...
                                <a class="breadcrumb-item" href="tabel_pengiriman.php">Pengiriman Obat</a>
                                <span class="breadcrumb-item active">Atur Pengiriman</span>
                            </nav>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <p><?php echo $row["opsi_pengiriman"]; ?></p>
                                </div>
                            </div>
                            <form method="POST">
