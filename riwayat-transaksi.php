            ...
            <div class="page-container">
                ...
                <div class="main-content">
                    <div class="page-header">
                        <h2 class="header-title">Riwayat Transaksi</h2>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="m-t-25">
                                <?php
                                    $result = $conn -> query("SELECT * FROM transaksi JOIN reservasi ON transaksi.reservasi_id = reservasi.reservasi_id WHERE user_id = '$user_id';");
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="<?php echo $row['transaksi_id'];?>">
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                    <a href="invoice.php?transaksi_id=<?php echo $row['transaksi_id'];?>" class="btn btn-link">
                                                        Lihat Invoice
                                                    </a>
                                                <?php
                                                }else {
